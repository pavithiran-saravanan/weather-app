...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ displayWeather)\n/* harmony export */ });\n/* harmony import */ var _getCurrentData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getCurrentData */ \"./src/javascript/getCurrentData.js\");\n/* harmony import */ var _getCurrentItems__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getCurrentItems */ \"./src/javascript/getCurrentItems.js\");\n/* harmony import */ var _getHourlyData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getHourlyData */ \"./src/javascript/getHourlyData.js\");\n/* harmony import */ var _getHourlyItems__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getHourlyItems */ \"./src/javascript/getHourlyItems.js\");\n/* harmony import */ var _getWeatherData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./getWeatherData */ \"./src/javascript/getWeatherData.js\");\n\n\n\n\n\n\nfunction displayWeather(src) {\n  // Start of loading\n  // loading.classList.remove(\"hidden\");\n  // currentContainer.classList.add(\"inactive\");\n  // hourlyContainer.classList.add(\"inactive\");\n  // error.classList.add(\"hidden\");\n\n  // Response from API\n  const myWeather = (0,_getWeatherData__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(src);\n\n  // Get current data and display\n  myWeather\n    .then((data) => {\n      if (!data) return;\n      const filteredData = (0,_getCurrentData__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(data);\n      const currentItems = (0,_getCurrentItems__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(filteredData);\n      console.log(filteredData, currentItems);\n      // currentWeatherIcon.src = filteredData.weatherIcon;\n      // windDirectionIcon.style.rotate = `${filteredData.windDegree}deg`;\n      // currentContainer.textContent = \"\";\n      // getCurrentItems(filteredData).forEach((item) =>\n      //   currentContainer.append(item)\n      // );\n    })\n    .catch((err) => console.log(err));\n\n  // Get hourly data and display\n  myWeather\n    .then((data) => {\n      if (!data) return;\n      const hourlyData = (0,_getHourlyData__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(data);\n      const hourlyItems = (0,_getHourlyItems__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(hourlyData);\n      console.log(hourlyData, hourlyItems);\n\n      const set1 = document.querySelector(\".set-1\");\n      const set2 = document.querySelector(\".set-2\");\n      const set3 = document.querySelector(\".set-3\");\n\n      set1.replaceChildren(...hourlyItems.slice(0, 8));\n      set2.replaceChildren(...hourlyItems.slice(8, 16));\n      set3.replaceChildren(...hourlyItems.slice(16, 24));\n\n      // End of loading\n      // loading.classList.add(\"hidden\");\n      // currentContainer.classList.remove(\"inactive\");\n      // hourlyContainer.classList.remove(\"inactive\");\n    })\n    .catch((err) => console.log(err));\n}\n\n\n//# sourceURL=webpack://weather-app/./src/javascript/displayWeather.js?");
